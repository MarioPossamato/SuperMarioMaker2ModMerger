...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def exists(self, sarc, filename): #==== Function to check if a file exists in an archive ====#
        try:
            sarc[filename]
        except KeyError:
            return False
    ...
    def ChooseInDir(self): #==== Function to choose a directory ====#
        inDir = ''
    ...
    def ChooseOutDir(self): #==== Function to choose a directory ====#
        outDir = ''
    ...
    def AddDir(self): #==== Function to add a directory ====#
        Dir = ''
    ...
    def RemoveDir(self): #==== Function to remove a directory ====#
        Dirs = []
